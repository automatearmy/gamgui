...
class WebSocketController:
    ...
    def __init__(self, auth_service: AuthService, gam_service: GamService):
    ...
    async def handle_connection(self, websocket: WebSocket) -> None:
        ...
        # Accept the WebSocket connection immediately (no auth)
        ...
        await self.send_message(websocket, {
            ...
            "message": "Connected to GAM session worker (no auth)",
    ...
    async def _handle_cancel(self, websocket: WebSocket, message: Dict[str, Any]) -> None:
        ...
        if command_id:
            ...
            await self.send_message(websocket, {
                "type": "cancelled",
                "message": f"Cancelled {cancelled_count} running commands"
            })

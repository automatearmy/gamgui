/**
 * Script para verificar a resposta da API diretamente
 */
...
async function checkGetSessionStatus(sessionId) {
...
async function main() {
  ...
  // Criar sessão
  const createResult = await checkCreateSession();
  ...
  await checkGetSessionStatus(sessionId);

...
**[Gamgui](https://gamgui.com)** is the open source and self-hostable centrally managed [GAM](https://github.com/GAM-team/GAM) Server. Built for Google IT admins that need to have security, audit logs, access controls, and manage long running GAM jobs with ease.
...
This repo available under the [MIT expat license](https://github.com/Infisical/infisical/blob/main/LICENSE), with the exception of the `ee` directory which will contain premium enterprise features requiring a Gamgui license.

As of June 14th, 2025, there are no premium enterprise features and thus a license is not required whatsoever. When new features are released that are part of the entierprise license it will be clear as to what features are in that category.
...
- Join the <a href="">GAM Google Group Community</a>, and ask us any questions there or send an email to team@automatearmy.com.

## Resources

- [Docs](https://gamgui.com/docs/) for comprehensive documentation and guides
- [GAM Community]() for discussion with the community and GAM & Automate Army team.

...
import { endSession, getSession, getSessionWebsocketInfo, uploadSessionFiles } from "@/lib/api";
import { createSessionWebsocket, createTerminalConnection } from "@/lib/socket";
          ...
          <div className="mt-4 pt-4 border-t">
            ...
            <ul className="space-y-1 text-xs">
              ...
              <li>
                ...
                {" "}
                {sessionDetails?.imageName || "N/A"}
              </li>
              <li>
                <span className="text-muted-foreground">Created:</span>
                {" "}
                {sessionDetails?.createdAt ? new Date(sessionDetails.createdAt).toLocaleString() : "N/A"}
              </li>
            </ul>
          </div>
        </Card>
